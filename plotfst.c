/***********************************************************************
	...
	$Id: plotfst.c,v 1.22 2022/11/19 13:45:53 warme Exp $
...
static struct battery_info* global_battery_info = NULL;
/*
 * External References
 */
...
gst_scale_info_ptr	sip;
	...
	global_battery_info = load_battery_info("batteries.txt", nverts);
